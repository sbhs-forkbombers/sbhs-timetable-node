...
function getNextEndEvent() {
	...
	return {
		'moment': currentTermEnd,
		'termNum': curTerm,
		'eventType': currentTermEnd.format('YYYY-MM-DD') == terms.terms[curTerm].start.date ? 'start': 'end'
	};
}

module.exports.isHolidays = isHolidays;
module.exports.getNextEndEvent = getNextEndEvent;
